"""
Django settings for sadasdsad_3 project.
...
WSGI_APPLICATION = 'sadasdsad_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sadasdsad_3 API",
    "DESCRIPTION": "API documentation for sadasdsad_3 App",
    "VERSION": "v1",
}
